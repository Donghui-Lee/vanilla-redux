...
var DECREASE = 'DECREASE'; // Action 생성 함수
...
var store = (0, _redux.createStore)(reducer); // DOM 참조
...
var btnDecrease = document.querySelector('#decrease'); // render 함수 (상태가 업데이트 될 때마다 호출)
...
render(); // subscribe 사용하여 상태가 바뀔 때마다 render 함수 호출

store.subscribe(render); // 액션 발생
...
},{"redux":"node_modules/redux/es/redux.js"}],"../../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
